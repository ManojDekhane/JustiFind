  ...
  const testimonials = [
    {
      ...
      avatar: 'SM',
      rating: 5,
      text: 'I liked how the AI breaks down complex legal terms into simple explanations. It’s actually useful for real-life situations like rentals and online issues.',
      location: 'Pune',
      verified: true,
    },
    {
      ...
      avatar: 'RM',
      rating: 5,
      text: 'I didn’t know much about cyber laws before, but this platform helped me understand things like online fraud and data privacy in a very simple way. Feels like a legal Google but smarter.',
      location: 'Mumbai',
      verified: true,
    },
    {
      ...
      avatar: 'AD',
      rating: 5,
      text: 'The UI is very clean and the AI assistant actually explains laws in a human way. I tried asking about consumer complaints and got step-by-step guidance instantly.',
      location: 'Delhi',
      verified: true,
    },
    {
      ...
      role: 'Commerence Student',
      avatar: 'RJ',
      rating: 5,
      text: 'We usually ignore legal awareness as students, but this project made it interesting. It feels like having a legal friend available 24/7.',
  ...
  return (
    <section ref={sectionRef} className="py-24 px-4 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`relative transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
        >
          {/* Main testimonial */}
        ...
        {/* Trust badges */}
        <div
          className={`flex flex-wrap items-center justify-center gap-8 mt-16 pt-8 border-t border-border/50 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
        >
          {[
